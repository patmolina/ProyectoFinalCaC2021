<%-- 
    Document   : register
    Created on : Jan 7, 2022, 5:40:56 PM
    Author     : pato
--%>
...
<main class="container d-flex justify-content-center align-items-center gap-5" >
        ...
        <form class="row g-3" method="POST" action="/user/createUser" enctype="application/x-www-form-urlencoded">
            ...
            <div class="col-md-6">
              ...
              <input type="text" class="form-control" id="city" name="city" placeholder="Ingresa tu ciudad" required>
            </div>
            <div class="col-md-6">
              <label for="country" class="form-label">Pais</label>
              <input type="text" class="form-control" id="country" name="country" placeholder="Ingresa tu pais" required>
            </div>
            <div class="col-md-8">
              <label for="username" class="form-label">e-mail</label>
              <div class="input-group has-validation">
                <input type="email" class="form-control" id="email" name="email" placeholder="Ingresa un e-mail" aria-describedby="inputGroupPrepend" required>
              </div>
            </div>
